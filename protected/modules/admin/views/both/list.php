...
$this->breadcrumbs = array(
    Yii::t('string','Employer / Designer')
);
?><div>
    <h1 style="display: inline"><?php echo Yii::t('string', "Manage Employer / Designer"); ?></h1>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box <?php echo $this->portlet_color ?>">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-users"></i><?php echo Yii::t('string', "Employer / Designer List"); ?>
                </div>
            </div>
