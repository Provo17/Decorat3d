...
<div class="form-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label class="col-md-3 control-label"><?php echo Yii::t('string', "User Name"); ?></label>
                <div class="col-md-9">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="col-md-3 control-label"><?php echo Yii::t('string', "Email"); ?></label>
                <div class="col-md-9">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label class="col-md-3 control-label"><?php echo Yii::t('string', "Password"); ?></label>
                <div class="col-md-9">
                    <?php echo $form->passwordField($model, 'password', array('class' => 'form-control', 'placeholder' => '')); ?>                    
                    <?php echo $form->error($model, 'password'); ?>
                    <span style="color:#555"><?php echo Yii::t('string', "Note: Leave blank for no changes"); ?></span>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label class="col-md-3 control-label"><?php echo Yii::t('string', "Zip code"); ?></label>
                <div class="col-md-9">
...
<div class="form-actions right">
    <a href="<?php echo $this->createUrl('both/index') ?>" class="btn <?php echo $this->cancel_button; ?>">Cancel</a>
