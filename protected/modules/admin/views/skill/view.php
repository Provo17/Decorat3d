                ...
                <form class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><b>Zipcode:</b></label>
                                    <div class="col-md-9">
...
<!--                        <h3 class="form-section">Payment Options</h3>
                    ...
                    <div class="form-actions right">
                        <a href="<?php echo $this->createUrl('both/index') ?>" class="btn <?php echo $this->back_button; ?>">Back</a>
