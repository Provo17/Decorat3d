<section class="page-section1 gallery">
    <div class="container">
        <h1><?php echo Yii::t('string', "Manufacturer Catalogs"); ?></h1>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div id="view3d">
                                                    ...
                                                    <canvas data-uploadDir="manufacturer_catalog" data-href="<?php echo $design_img; ?>" data-catalogPrice="Price: $<?php echo sprintf("%.2f", $clg->price); ?>" data-rawImageName="<?php echo $clg->uploaded_file; ?>" data-description="<?php echo $description; ?>" id="cv_<?php echo $clg->id; ?>" width="555" height="308"></canvas>
                                                    <script>
                                                            ...
                                                            if (Yii::app()->user->isGuest) {
                                                                ...
                                                                if ($clg->manufacturer_id != Yii::app()->user->id) {
                                                                    ...
                                                                    if ($userData->user_type_id == '2') {
                                                                        ?>
                                                                        <a href="<?php echo Yii::app()->createUrl('/bid/' . $clg->id . '/add') ?>?src=manufacturer_catalog" class="btn btn-default btn-xs pull-right">Buy Now</a>
                                                                        <?php
                                                                    }
                                                                }
                                                            }
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div id="view3d">
                                                    <!-- HTML5 Canvas -->
                                                    <a id="image_save_url" href="<?php echo Yii::app()->createUrl('site/CanvasToImage'); ?>"></a>
                                                    <canvas data-uploadDir="manufacturer_catalog" data-href="<?php echo $design_img; ?>" data-catalogPrice="Price: $<?php echo sprintf("%.2f", $clg->price); ?>" data-rawImageName="<?php echo $clg->uploaded_file; ?>" data-description="<?php echo $description; ?>" id="cv_<?php echo $clg->id; ?>" width="260" height="200.5"></canvas>
                                                    <script>
                                                        $(document).ready(function() {
                                                            viewer3d('cv_' + "<?php echo $clg->id; ?>");
                                                        });
...
<script>
    ...
    function loadMore(key, offset, limit) {
        ...
        $.ajax({
            async: false,
            url: "<?php echo Yii::app()->createAbsoluteUrl('manufacturerDashboard/manufacturerCatalogLoadMore'); ?>",
            type: "GET",
            dataType: "json",
