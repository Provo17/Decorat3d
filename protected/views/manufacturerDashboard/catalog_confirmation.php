...
<div class="postDetail">
    ...
    if ($model->uploaded_file != '')
        ...
        if ($this->getFileExtention($model->uploaded_file) == 'stl')
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="view3d" style="text-align: center;">
                            ...
                            <canvas data-uploadDir="manufacturer_catalog" data-href="<?php echo Yii::app()->request->getBaseUrl(true) . "/upload/manufacturer_catalog/" . $model->uploaded_file; ?>"  data-rawImageName="<?php echo $model->uploaded_file; ?>"  id="cv" width="555" height="308"></canvas>
                            <script>
            ...
            {
            ?>
            <img src="<?php echo Yii::app()->request->getBaseUrl(true) . "/upload/manufacturer_catalog/" . $model->uploaded_file; ?>">
            <?php
            }
        }
    ?>
    ...
    <br/>
    <div>       
        <a  href="<?php echo Yii::app()->createUrl('manufacturerDashboard/uploadCatalog',['id'=>$model->id]);?>" class="btn btn-default btn-xs pull-left" >
            <span class="glyphicon glyphicon-confirm"></span> <?php echo Yii::t('string', "Edit"); ?> 
        </a>
        <a href="<?php echo Yii::app()->createUrl('manufacturerDashboard/catalogConfirmationActions',['id'=>$model->id]);?>?type=confirm" class="btn btn-success btn-xs pull-left" >
            <span class="glyphicon glyphicon-confirm"></span> <?php echo Yii::t('string', "Confirm"); ?> 
        </a>
        <a href="<?php echo Yii::app()->createUrl('manufacturerDashboard/catalogConfirmationActions',['id'=>$model->id]);?>?type=cancel" class="btn btn-danger btn-xs pull-left" >
