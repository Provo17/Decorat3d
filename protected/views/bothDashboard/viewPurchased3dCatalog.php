    ...
    <div class="row">
        <div class="col-md-12">
            <div id="view3d" style="text-align: center;">
                ...
                <canvas data-uploadDir="jobs" data-href="<?php echo Yii::app()->request->getBaseUrl(true) . "/upload/manufacturer_catalog/" . $rawImage; ?>"  data-rawImageName="<?php echo $rawImage; ?>"  id="cv" width="555" height="308"></canvas>
                <script>
