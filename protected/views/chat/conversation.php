                                ...
                                <ul>
                                    ...
                                    if (isset($chatThreads)) {
                                        ...
                                        foreach ($chatThreads as $chatThreads_index => $chatThread) {
                                            ...
                                            if ($requisted_chat_thread_id != '') {
                                                if ($chatThread->id == $requisted_chat_thread_id) {
                                            ...
                                            ?>
                                            <li class="<?php echo $threadActive; ?> chat_li" id="left_tab_<?php echo $chatThread->started_to; ?>" data-active_chat_master_id="<?php echo $activeChatThread; ?>" data-receiver_id="<?php echo $chatThread->started_to; ?>" data-chat_master_id="<?php echo $chatThread->id; ?>">
                                                <a href="#" class="<?php echo $threadActive; ?>"><div class="pImagep"><img src="<?php
                                                        if ($chatThread->user->profile_image) {
                                                            echo Yii::app()->baseUrl . '/upload/usersImage/thumb/' . $chatThread->user->profile_image;
                                                        } else {
                                                            echo Assets::themeUrl("images/avatarImage.jpg");
                                                        }
                                                        ?>" alt=""/></div>
                                                    <div class="nameDesigner"><p><span class="user_left"><?php echo $chatThread->user->username; ?></span><span id="left_tab_count_<?php echo $chatThread->started_to; ?>"></span></p></div>
                                    ...
                                    ?>
                                            <?php
                                    if (isset($chatThread1)) {

                                        
                                        $threadActive = 'chat_thread';
                                        $activeChatThread = '';
                                        foreach ($chatThread1 as $chatThreads_index => $chatThread) {
                                            $chatThreadCount = $chatThreadCount + 1;
                                            if ($requisted_chat_thread_id != '') {
                                                if ($chatThread->id == $requisted_chat_thread_id) {
                                                    $threadActive = 'chat_thread active curr_chat';
                                            ...
                                            <li class="<?php echo $threadActive; ?> chat_li" id="left_tab_<?php echo $chatThread->started_by; ?>" data-active_chat_master_id="<?php echo $activeChatThread; ?>" data-receiver_id="<?php echo $chatThread->started_by; ?>" data-chat_master_id="<?php echo $chatThread->id; ?>">
                                                <a href="#" class="<?php echo $threadActive; ?>"><div class="pImagep"><img src="<?php
                                                        ...
                                                        ?>" alt=""/></div>
                                                    <div class="nameDesigner"><p><span class="user_left"><?php echo $chatThread->user_by->username; ?></span><span id="left_tab_count_<?php echo $chatThread->started_by; ?>"></span></p></div>
                                                    <div class="dateDesigner">Aug 10</div></a>
                                            </li>
                                            <?php
                                        }
...
//                    window.location.href = "<?php // echo Yii::app()->createUrl('/chat/appendChatData');               ?>";
    ...
    $('#main_chat_form_submit').on('click', function(e) {
        e.preventDefault();
...
//        intervalData = $.ajax({
//            type: "POST",
//            url: '/apps/profileringsportalen/public/admin/notification/procesIntervalNotification',
//            // data: jQuery("#notification-form").serialize(),
//            data: {last_notification_id: $(".not-append-area").find("li").first().data("id"),
//                last_chat_time: $(".chat_not-append-area").find("li").first().data("last_chat_time"),
//            },
//            dataType: "json",
//            async: false
//        }).success(function(data) {
//            if (data.chat_not_type == 'success')
//            {
//                $(".chat_not-append-area").prepend(data.chat_html);
//                $('.chat_not_count').show();
//                $('.chat_not_count').html(data.chat_count);
//                $('#chat_notification_count').html(data.chat_count)
//            }
//            if (data.type == 'success') {
//                $(".not-append-area").prepend(data.html);
//                $('.not_count').show();
//                $('.not_count').html(data.count);
//                $('#notification_count').html(data.count);
//            } else if (data.type == 'logout') {
//                window.location.href = '';
//            }
//        }).always(function() {
//            lock_status = 0;//unlock it again
//        });
