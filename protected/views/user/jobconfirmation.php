<div class="row">
    <div class="col-md-12">
        <h2 class="top-title"> Posted Project Preview</h2>
    </div><!--col-md-12-->
</div>
...
<div class="postDetail">
    ...
    <div class="postDetailsP">
        <p><?php echo isset($model->description) ? $model->description : ''; ?></p>
        <p><b>Dimension: </b> <?php echo isset($model->dimention) ? $model->dimention : ''; ?></p>
        <p><b>Color: </b> <?php echo isset($model->colour) ? $model->colour : ''; ?></p>
    </div>
    <br/>
    <div>       
        <a  href="<?php echo Yii::app()->createUrl('user/jobPost',['id'=>$model->id]);?>" class="btn btn-default btn-xs pull-left" >
            <span class="glyphicon glyphicon-confirm"></span> Edit 
        </a>
        <a href="<?php echo Yii::app()->createUrl('user/jobConfirmationActions',['id'=>$model->id]);?>?type=confirm" class="btn btn-success btn-xs pull-left" >
            <span class="glyphicon glyphicon-confirm"></span> Confirm 
        </a>
        <a href="<?php echo Yii::app()->createUrl('user/jobConfirmationActions',['id'=>$model->id]);?>?type=cancel" class="btn btn-danger btn-xs pull-left" >
