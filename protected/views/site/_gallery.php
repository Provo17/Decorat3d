                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="view3d">
                                    ...
                                    <canvas class="canvs" data-uploadDir="catalog" data-href="<?php echo $design_img; ?>" data-catalogPrice="Price: $<?php echo sprintf("%.2f", $clg->price); ?>" data-rawImageName="<?php echo $clg->uploaded_file; ?>" data-description="<?php echo $description; ?>" id="cv_<?php echo $clg->id; ?>" width="260" height="202"></canvas>
            <!--                                    <script>
                                        function a() {
                                            console.log('asd');
