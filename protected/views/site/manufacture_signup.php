                    ...
                    <div class="col-md-12">
                        ...
                        <div class="social-login">
                            <ul>
                                ...
                                <li><a href="<?php echo Yii::app()->homeUrl; ?>sns-auth?service=facebook&type=manufacturer" class="auth-service facebook"><img src="<?php echo Assets::themeUrl("images/social-ico1.png"); ?>"></a></li>
                                <li><a href="<?php echo Yii::app()->homeUrl; ?>sns-auth?service=twitter&type=manufacturer" class="auth-service google_oauth"><img src="<?php echo Assets::themeUrl("images/social-ico2.png"); ?>"></a></li>
                                <li><a href="<?php echo Yii::app()->homeUrl; ?>sns-auth?service=linkedin&type=manufacturer" class="auth-service"><img src="<?php echo Assets::themeUrl("images/social-ico3.png"); ?>"></a></li>
                                <li>
                                    <!--<a href="#"><img src="<?php echo Assets::themeUrl("images/social-ico4.png"); ?>"></a>-->
                                </li>
                                <li><a href="<?php echo Yii::app()->homeUrl; ?>sns-auth?service=google_oauth&type=manufacturer" class="auth-service google_oauth"><img src="<?php echo Assets::themeUrl("images/social-ico5.png"); ?>"></a></li>
                            </ul>
                        </div>
