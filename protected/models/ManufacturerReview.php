...
/**
 * This is the model class for table "manufacturer_review".
 *
 * The followings are the available columns in table 'manufacturer_review':
 * @property string $id
 ...
 */
class ManufacturerReview extends Model
    {

    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ManufacturerReview the static model class
     */
...
// will receive user inputs.
        return array(
            array('by_user, to_user, job_bid_id, review, rating, status', 'required'),
...
// class name for the relations automatically generated below.
        return array(
            'manufacturer_job_bid' => array(self::BELONGS_TO, 'ManufacturerJobBid', 'job_bid_id'),
        );
    }
