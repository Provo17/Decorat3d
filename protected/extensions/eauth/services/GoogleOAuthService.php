...
class GoogleOAuthService extends EOAuth2Service {
	...
	protected $scope = 'https://www.googleapis.com/auth/plus.login https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/plus.me';
	...
	protected function fetchAttributes() {
		...
		if (!empty($info['gender']))
			$this->attributes['sex'] = $info['gender'] == 'male' ? '6' : '7';
		
		if (!empty($info['picture']))
			$this->attributes['profile_image'] = $info['picture'];
