...
class LinkedinOAuthService extends EOAuthService {
	...
	protected function fetchAttributes() {
		$info = $this->makeSignedRequest('http://api.linkedin.com/v1/people/~:(id,first-name,last-name,picture-url,public-profile-url,email-address)', array(), false); // json format not working :(
		...
		$this->attributes['url'] = $info['public-profile-url'];
                ...
                //$this->attributes['email'] = $info['picture-url'];
	}
